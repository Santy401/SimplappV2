...
const badgeVariants = cva("inline-flex items-center justify-center rounded-full border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden", {
    variants: {
        variant: {
            default: "border-transparent bg-primary text-primary-foreground [a&]:hover:bg-primary w-19 text-black",
            secondary: "border-transparent bg-secondary text-secondary-foreground [a&]:hover:bg-secondary/90",
            destructive: "border-transparent bg-red-500 text-foreground [a&]:hover:bg-destructive/90 w-19 flex items-center focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40",
            active: "border-transparent bg-green-500 text-foreground [a&]:hover:bg-green-500/90 w-19 flex items-center focus-visible:ring-green-500/20 dark:focus-visible:ring-green-500/40",
