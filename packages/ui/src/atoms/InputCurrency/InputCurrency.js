...
export const InputCurrency = React.forwardRef(({ value, onChange, locale = "es-CO", currency = "COP", ...props }, ref) => {
    ...
    return (_jsx(Input, { ...props, ref: internalRef, type: "text", value: displayValue, onChange: handleChange, onBlur: handleBlur, onFocus: handleFocus }));
});
