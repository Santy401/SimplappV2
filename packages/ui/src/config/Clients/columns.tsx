...
import { formatIdentificationType, getFullName } from "../../../../interfaces/src/hooks/features/Clients/utils/index";
            ...
            cell: (client: Client) => (
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center font-semibold">
                        {getFullName(client).split(" ").map((n: string) => n[0]).join("").substring(0, 2).toUpperCase()}
                    </div>
