...
import {
    ...
    NotificationTab,
    NotificationType,
} from "@interfaces/src/hooks/features/notifications/use-notifications";
                                ...
                                {notifications.length === 0 ? (
                                    <div className="flex flex-col items-center justify-center py-16 text-center px-8">
                                        ...
                                        <p className="text-sm font-medium text-slate-700 dark:text-slate-300">
                                            {activeTab === "archivo" ? "Archivo vacío" : activeTab === "novedades" ? "Sin novedades" : "Todo al día"}
                                        </p>
                                        <p className="text-xs text-slate-400 mt-1">
                                            {activeTab === "archivo" ? "Las notificaciones archivadas aparecerán aquí." : "No tienes notificaciones pendientes."}
                                        </p>
                                    </div>
                                ) : (
