...
const SEARCHABLE_ITEMS: SearchResult[] = [
    { id: "inicio", label: "Inicio", description: "PÃ¡gina principal", icon: <Home size={18} />, category: "NavegaciÃ³n" },
    { id: "dashboard", label: "Dashboard", description: "Panel de control", icon: <BarChart3 size={18} />, category: "NavegaciÃ³n" },
    { id: "ventas-facturacion", label: "FacturaciÃ³n", description: "Facturas de venta", icon: <FileText size={18} />, category: "NavegaciÃ³n" },
    { id: "ventas-clientes", label: "Clientes", description: "GestiÃ³n de clientes", icon: <Users size={18} />, category: "NavegaciÃ³n" },
    { id: "ventas-productos", label: "Productos De Venta", description: "CatÃ¡logo de productos", icon: <Package size={18} />, category: "NavegaciÃ³n" },
    { id: "ventas-vendedor", label: "Vendedores", description: "GestiÃ³n de vendedores", icon: <User size={18} />, category: "NavegaciÃ³n" },
    { id: "ventas-bodega", label: "Bodega", description: "GestiÃ³n de bodegas", icon: <Store size={18} />, category: "NavegaciÃ³n" },
    { id: "inventario-precios", label: "Lista De Precios", description: "Precios de inventario", icon: <Tag size={18} />, category: "NavegaciÃ³n" },
]
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Panel de resultados con animaciÃ³n de apariciÃ³n */}
                <div
                    style={{
                ...
                {/* Mensaje cuando no hay resultados pero ya terminÃ³ de buscar */}
